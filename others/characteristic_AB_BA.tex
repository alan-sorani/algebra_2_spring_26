...
לפי כך, מתקיים
\begin{align*}
p_{AB}\prs{x} \det\prs{A} &=
\det\prs{xI_n - AB} \det\prs{A}
\\&=
\det\prs{\prs{x I_n - AB} A}
\\&=
\det\prs{x A - ABA}
\\&=
\det\prs{A \prs{x I_n - BA}}
\\&=
\det\prs{A} \det\prs{x I_n - BA}
\\&=
\det\prs{A} p_{BA}\prs{x}
\end{align*}
ולאחר חלוקה ב־%
$\det\prs{A}$
נקבל את השוויון הנדרש.
\end{proof}
