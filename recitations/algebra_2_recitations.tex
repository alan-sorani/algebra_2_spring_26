...
\begin{align*}
\det\prs{A_i} &= b_1 \det\prs{A_{\prs{1,i}}} + \ldots + b_n \det\prs{A_{\prs{n,i}}}
\\&= \sum_{j \in [n]} b_j \det\prs{A_{\prs{j,i}}}
\\&= \pmat{\det\prs{A_{\prs{1,i}}} & \cdots & \det\prs{A_{\prs{n,i}}}} b
\end{align*}
לכן אם נגדיר מטריצה
$\adj\prs{A} \in \Mat_n\prs{\FF}$
שמקיימת
$\prs{\adj\prs{A}}_{i,j} = \det\prs{A_{\prs{j,i}}}$
לכל
$i,j \in [n]$,
נקבל כי
