...
\item
\begin{align*}
f_1 \colon \Mat_n\prs{\mbb{R}} \times \Mat_n\prs{\mbb{R}} &\to \mbb{R} \\
\prs{A,B} &\mapsto \tr\prs{B^t A}
\end{align*}

\item
\begin{align*}
f_2 \colon \Mat_n\prs{\mbb{C}} \times \Mat_n\prs{\mbb{C}} &\to \mbb{C} \\
\prs{A,B} &\mapsto \tr\prs{B^t A}
\end{align*}

\item
\begin{align*}
f_3 \colon \mbb{R}_{\leq n}\brs{x} \times \mbb{R}_{\leq n}\brs{x} &\to \mbb{R} \\
\prs{f,g} &\mapsto f\prs{0} g\prs{0} + \ldots + f\prs{n} g\prs{n}
\end{align*}

\item
\begin{align*}
f_4 \colon \mbb{C}_{\leq n}\brs{x} \times \mbb{C}_{\leq n}\brs{x} &\to \mbb{C} \\
\prs{f,g} &\mapsto f\prs{0} g\prs{0} + \ldots + f\prs{n} g\prs{n}
\end{align*}
\end{enumerate}
\end{exercise}
